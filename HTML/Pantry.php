...
<div class="container">
    ...
    <div class="maincontent">
        ...
        <div class="allmc">
            <h1 class="allheading" style="border-color: #F8BBD0;">Pantry</h1>
            <select id="category-dropdown" onchange="onCategoryChange()">
                <option value="pantry">Shop All</option>
                <option value="cannedgoods-pantry"> canned goods</option>
                <option value="vegetables-pantry">canned vegetables</option>
                <option value="condiments-pantry">condiments</option>
                <option value="peanut-pantry">peanut butter & spread</option>
                <option value="pizza-pantry">pasta&pizza</option>
                <option value="rollbacks-pantry">Rollbacks</option>
            </select>
