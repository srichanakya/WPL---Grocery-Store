...
<div class="container">
    ...
    <p>When you bake food, such as bread or cookies, the Maillard reaction occurs. It's a complex chemical reaction between amino acids and reducing sugars that creates a beautiful brown crust and imparts rich flavors to your baked goods. This reaction is responsible for the delicious aroma and taste of freshly baked bread and cookies.</p>
    <h4 id="currentdatetime"></h4>    
</div>
    <div class="maincontent">
        <div class="allmc">
            <h1 class="allheading" style="border-color: #FFA726">Baking</h1>
