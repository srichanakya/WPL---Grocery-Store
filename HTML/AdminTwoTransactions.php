...
$sql = "SELECT cu.CustomerID as CID, cu.FirstName as FN, t.TransactionDate as TD,t.TransactionID as TID, COUNT(t.TransactionID) as TC
        FROM Carts c
...
<div id="tablecontainer">
            ...
            echo "<h2>Transaction Date: $TDate</h2>";
            echo "<table border='1'>
                    <tr>
                        <th>CustomerID</th>
                        <th>TransactionID</th>
